...
import project.honey.personDepart.service.Service020302;
...
@Slf4j
@RequestMapping("/020302")
public class Controller020302 {

    private final Service020101 service020101;
    private final Service020102 service020102;
    private final Service020302 service020302;
    ...
    public String popUp(@PathVariable("empNo") String empNo, Model model){
        ...
        PrintData020302 data = service020302.getData(empNo);
        log.info("data = {}", data);
