...
public class Controller020102 {
    ...
    @PostMapping("/insert")
    public String insert(@ModelAttribute Form020102 form, Model model, HttpServletRequest request){
    ...
    @PostMapping("/update")
    public String update(@ModelAttribute Form020102 form, Model model, HttpServletRequest request){
