...
import project.honey.personDepart.service.Service020303;
...
@Slf4j
@RequestMapping("/020303")
public class Controller020303 {

    private final Service020101 service020101;
    private final Service020102 service020102;
    private final Service020303 service020303;
    ...
    public String findAll(@RequestParam Map<String, String> map,
        ...
        return "personDepart/020303";
    }

    @GetMapping("/popup/{empNo}")
    public String popUp(@PathVariable("empNo") String empNo, Model model){
        log.info("경력증명서 print");

        PrintData020303 data = service020303.getData(empNo);
        log.info("data = {}", data);
        ...
        String leaveDt = data.getLeaveDt();
        String leaveDate = leaveDt.substring(0, 4) + "-" + leaveDt.substring(4, 6) + "-" + leaveDt.substring(6, 8);
        ...
        return "personDepart/020303_prt";
    }
}
