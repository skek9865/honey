...
@Builder
@Table(name = "tb_601")
public class Tb601 extends BaseAtt {
    ...
    @OneToMany(mappedBy = "tb601", orphanRemoval = true, cascade = CascadeType.ALL)
    private List<Tb601_1> tb601_1s;

    // 컬렉션 채우기
    public void addList(List<Tb601_1> list) {
        tb601_1s.addAll(list);
    }

    public void updateData(Tb601Form dto, List<Tb601_1> tb601_1s) {
