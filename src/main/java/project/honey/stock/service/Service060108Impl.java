...
public class Service060108Impl implements Service060108 {

    private final Tb603Repository tb603Repository;
    private final CodeToName codeToName;

    @Override
    public Page<Dto060108> findAll(Search060103 search, Pageable pageable) {

        // 날짜 부호 빼주기
        Search060103 realSearch = new Search060103(GlobalMethod.replaceYmd(search.getYmd1(), "-"),
                GlobalMethod.replaceYmd(search.getYmd2(), "-"), null, "00001");
        ...
        List<Dto060108> dtoList = new ArrayList<>();
        // 화면에 출력할 데이터 생성
        for (Tb603 tb603 : tb603s) {
            ...
            Dto060108 dto = Dto060108.of(tb603, goodsNm, qty);
            dtoList.add(dto);
        }
