...
public interface Tb410RepositoryDsl {
    ...
    Page<Tb410> findAllBy040302(String ymd1, String ymd2, Search040302 search040302, List<Integer> seqList, Pageable pageable);
    List<Tb410> findAllBy040302Excel(String ymd1, String ymd2, Search040302 search040302, List<Integer> seqList);
}
